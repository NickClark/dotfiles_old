...
= Nick Clarks Dot Files

These are config files to set up a system the way I like it.
Most of this readme is left as Ryan Bates created it. Thanks Ryan!
This also uses oh-my-zsh and akitas vimfiles which are included as submodules.


== Installation

  git clone git://github.com/NickClark/dotfiles_old ~/.dotfiles_old
  cd ~/.dotfiles
  git submodule init
  git submodule update
  rake install

  Note: you may also have to go into the vim folder and call repeat steps 3 and 4 ie:
  git submodule init
  git submodule update
...
Keys you should know about in vim:
\p - open NerdTree
